...
vi.mock('./MessageBubble', () => ({
  ...
  // Fork: ChatView renders an AssistantHeader above the streaming tail.
  AssistantHeader: (props: { name: string }) => (
    <div data-testid="mock-assistant-header">{props.name}</div>
  ),
  sourceLabel: () => 'agent',
}))
